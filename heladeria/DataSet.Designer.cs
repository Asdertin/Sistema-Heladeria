...
namespace heladeria {
    ...
    public partial class DataSet : global::System.Data.DataSet {
        ...
        public partial class ProductoDataTable : global::System.Data.TypedTableBase<ProductoRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public ProductoRow AddProductoRow(string Descripcion, double Precio, int Existencia, CategoriaRow parentCategoriaRowByCategoria_Producto, TipoRow parentTipoRowByTipo_Producto, bool Activo, byte[] foto) {
...
namespace heladeria.DataSetTableAdapters {
    ...
    public partial class ProductoTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Producto] ([Descripcion], [Precio], [Existencia], [CategoriaId], [TipoId], [Activo], [foto]) VALUES (@Descripcion, @Precio, @Existencia, @CategoriaId, @TipoId, @Activo, @foto);
SELECT id, Descripcion, Precio, Existencia, CategoriaId, TipoId, Activo, foto FROM Producto WHERE (id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Producto] SET [Descripcion] = @Descripcion, [Precio] = @Precio, [Existencia] = @Existencia, [CategoriaId] = @CategoriaId, [TipoId] = @TipoId, [Activo] = @Activo, [foto] = @foto WHERE (([id] = @Original_id) AND ([Precio] = @Original_Precio) AND ([Existencia] = @Original_Existencia) AND ([CategoriaId] = @Original_CategoriaId) AND ([TipoId] = @Original_TipoId) AND ([Activo] = @Original_Activo));
SELECT id, Descripcion, Precio, Existencia, CategoriaId, TipoId, Activo, foto FROM Producto WHERE (id = @id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::heladeria.Properties.Settings.Default.HeladeriaConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT id, Descripcion, Precio, Existencia, CategoriaId, TipoId, Activo, foto FRO" +
                "M dbo.Producto";
        ...
        public virtual int Insert(string Descripcion, double Precio, int Existencia, int CategoriaId, int TipoId, bool Activo, byte[] foto) {
            if ((Descripcion == null)) {
        ...
        public virtual int Update(string Descripcion, double Precio, int Existencia, int CategoriaId, int TipoId, bool Activo, byte[] foto, int Original_id, double Original_Precio, int Original_Existencia, int Original_CategoriaId, int Original_TipoId, bool Original_Activo, int id) {
            if ((Descripcion == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Descripcion, double Precio, int Existencia, int CategoriaId, int TipoId, bool Activo, byte[] foto, int Original_id, double Original_Precio, int Original_Existencia, int Original_CategoriaId, int Original_TipoId, bool Original_Activo) {
            return this.Update(Descripcion, Precio, Existencia, CategoriaId, TipoId, Activo, foto, Original_id, Original_Precio, Original_Existencia, Original_CategoriaId, Original_TipoId, Original_Activo, Original_id);
        }
    }
